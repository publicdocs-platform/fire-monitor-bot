...
exports.getPerimeters = function(ua, callback) {
  ...
  rp(perimDataOptions).then(function (resp) {
    try {
...
exports.getFires = function(ua, callback) {
  ...
  rp(firesDataOptions).then(function (resp) {
    try {
      const data = resp.features;
